...
import com.tmax.eTest.Common.repository.comment.CommentKnowledgeRepo;
...
public class CommentKnowledgeService {
	...
	public Map<String, List<CommentDTO>> getAllComment()
	{
		...
		List<CommentKnowledge> allComment = commentRepo.findAll();
		
		for(CommentKnowledge comment : allComment)
		{
