...
public interface VideoRepository extends JpaRepository<Video, String> {
  ...
  @Query("select new com.tmax.eTest.Contents.dto.VideoJoin(v, vb.userUuid) from Video v left outer join VideoBookmark vb on (v.videoId = vb.videoId and vb.userUuid = :user_id) where v.curriculumId = :curriculum_id")
